...
/// Sets up a 5xBR (round) pixel art upscaling shader.
/// 
...
{
    static _uniformTexel       = shader_get_uniform(__shd5xBRRound, "u_vTexel");
    static _uniformTextureSize = shader_get_uniform(__shd5xBRRound, "u_vTextureSize");
