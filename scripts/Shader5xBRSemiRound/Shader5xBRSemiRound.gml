...
/// Sets up a 5xBR (semi-round) pixel art upscaling shader.
/// 
...
function Shader5xBRSemiRound(_texture)
{
    static _uniformTexel       = shader_get_uniform(__shd5xBRSemiRound, "u_vTexel");
    static _uniformTextureSize = shader_get_uniform(__shd5xBRSemiRound, "u_vTextureSize");
